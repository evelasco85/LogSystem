...
{
    public interface IEventGreatherThanExpression
    {
    }

    public class EventGreatherThanExpression : EventBoolean, IEventGreatherThanExpression
    {
        ...
        public EventGreatherThanExpression(IEventData data1, IEventData data2)
        {
            _data1 = data1;
            _data2 = data2;
        }
